...
import 'package:donut_app_2c_ruiz/pages/home_page.dart';
import 'package:donut_app_2c_ruiz/pages/auth/signup_page.dart';
...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
  ...
  bool _isPasswordLogin = true; // Alternar entre enlace mágico y login con contraseña
              ...
              children: [
                    ...
                    onTap: (index) {
                      if (index == 1) {
                        ...
                        Future.delayed(const Duration(milliseconds: 300), () {
                          _navigateToSignup();
                          _tabController.animateTo(0); // Volver a la pestaña de login
                        });
                      }
                    },
                  ),
                ...
                Align(
                  ...
                  child: TextButton(
                    ...
                    child: Text(
                      _isPasswordLogin ? 'Forgot password?' : 'Use password instead',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: _isLoading ? null : (_isPasswordLogin ? _signInWithPassword : _sendPasswordResetEmail),
